...
public class SolicitudPolizaDAO {
	 ...
	 */
	public void insert(SolicitudPoliza c) {
		em.persist(c);
	}
	 ...
	 */
	public void update(SolicitudPoliza c) {
		em.merge(c);
	} 
	 ...
	 */
	public SolicitudPoliza read(String cedulaCliente) {
		return em.find(SolicitudPoliza.class, cedulaCliente);
	} 
	...
	public void delete(String cedulaCliente) {
		SolicitudPoliza c = read(cedulaCliente);
		em.remove(c);
	}
	...
	public List<SolicitudPoliza> getSolicitudPolizas() {
		String jpql = "SELECT c FROM SolicitudPoliza c ";
