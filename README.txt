...
a persistence unit "BancaVirtualFPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BancaVirtualF\pom.xml":
...
artifact ("BancaVirtualF.war") is already built. You can build
